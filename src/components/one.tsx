...
export default function One() {
    return (
        <div className="w-full h-[120vh] flex justify-center bg-gradient-to-b from from-[#161726] from-5% via-[#191A30] to-[#191A30]">
            <div className="grid grid-cols-2 mt-[92px] w-[1000px]">
                <div>
                    <Image src="/assets/img-two.png" alt="logo" width={464} height={650}/>
                    <Image className="mt-8 ml-7 z-20 absolute" src="/assets/detail.png" alt="logo" width={300} height={180}/>
                    <div className="w-[686px] h-[201px] rounded-[32px] bg-[#121323] relative top-[-250px] left-80 text-white pt-12 px-12">
                    ...
                    <div className="w-[686px] h-[249px] rounded-[32px] bg-[#2168FC] relative top-[-185px] left-80 text-white pt-12 px-12 mb-5 z-10">
