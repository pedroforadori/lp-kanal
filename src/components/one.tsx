...
export default function One() {
    return (
        <div className="w-full h-[120vh] flex flex-col items-center justify-center bg-gradient-to-b from from-[#161726] from-5% via-[#191A30] to-[#191A30] max-sm:flex-col max-sm:h-auto px-36">
